        ...
        <>
            ...
            <SafeAreaView style={styles.container}>
                <View style={styles.main}>
                    <Text style={styles.title}>KalSum</Text>
                    ...
                    <TextInput
                        style={styles.input}
                        placeholder="Hasiholan Owen Ambarita"
                ...
                <View style={styles.bottomBar}>
                    <View style={styles.navbar}>
                        <TouchableOpacity
                            ...
                            <Text style={styles.buttonbarText}>Home</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={styles.buttonbottomBar}
                            onPress= {() => navigation.navigate('Order')}>
                            <Icon name="book" size={30} color='#283593'/>
                            <Text style={styles.buttonbarText}>Riwayat</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={styles.buttonbottomBar}
                            onPress= {() => navigation.navigate('Home')}>
                        ...
                        <TouchableOpacity
                            ...
                            <Text style={styles.buttonbarText}>Menu</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </SafeAreaView>
